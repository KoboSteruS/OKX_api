...
### 4. Получение комплексных рыночных данных (GET)

```bash
curl "http://localhost:8000/api/v1/market-data?inst_id=ETH-USDT"
```

**Включает**: тикер, стакан ордеров, свечи за 24 часа (5-минутные интервалы), информацию об инструменте, статус системы
