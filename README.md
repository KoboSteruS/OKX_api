...
## 🔧 Настройка API ключа для демо-торговли

Для работы с демо-торговлей в OKX необходимо:

### 1. Создание API ключа в OKX
1. Войдите в аккаунт OKX
2. Перейдите в **API Management**
3. Создайте новый API ключ с настройками:
   - **Название**: `Demo_Trading_Bot`
   - **Разрешения**: `Чтение`, `Торговля`
   - **IP-адрес**: Оставьте пустым или укажите ваш IP
   - **Торговля**: ✅ Включена
   - **Демо-торговля**: ✅ Включена
...
# Заполните настройки
OKX_API_KEY=ваш_api_ключ
OKX_API_SECRET=ваш_секретный_ключ
